...
class OnlineDatabase{
  ...
  static Future<dynamic> postPayment({String customerCode, String imageUrl, String lat, String long, String paymentMode, String checkNumber, String amount, String name, String date}){
    String url=
    paymentMode=='1'?
    directory+'postcollection?pin_cmp=20&pin_kp=A&pin_keyword1=6731&pin_keyword2=U09Z&pin_userid=$phoneNumber&pin_password=$password&pin_cust_code=$customerCode&pin_longitude=$long&pin_latitude=$lat&pin_pay_mode=$paymentMode&pin_cheq_date=&pin_amount=$amount&pin_rcvd_from=$name&file_type&file_name'
        :directory+'postcollection?pin_cmp=20&pin_kp=A&pin_keyword1=6731&pin_keyword2=U09Z&pin_userid=$phoneNumber&pin_password=$password&pin_cust_code=$customerCode&pin_image_url=${imageUrl}&pin_longitude=$long&pin_latitude=$lat&pin_pay_mode=$paymentMode&pin_cheq=$checkNumber&pin_cheq_date=$date&pin_amount=$amount&pin_rcvd_from=$name&file_type&file_name';
   ...
   static Future<dynamic> getLedger({String customerCode,String ledgerType,String fromDate,String toDate}) async {
    var url=Uri.parse(directory+'gettransactions?pin_cmp=20&pin_kp=A&pin_keyword1=6731&pin_keyword2=U09Z&pin_userid=$phoneNumber&pin_password=$password&pin_cust_code=$customerCode&pin_datatype=$ledgerType&pin_fromdate=$fromDate&pin_todate=$toDate');
  ...
  static Future<dynamic> getStockLedger({ String ledgerType,String fromDate,String toDate}){
    var url=Uri.parse(directory+'getstocks?pin_cmp=20&pin_kp=A&pin_keyword1=6731&pin_keyword2=U09Z&pin_userid=$phoneNumber&pin_password=$password&pin_datatype=$ledgerType&pin_fromdate=$fromDate&pin_todate=$toDate');
    // var url=Uri.parse(directory+'getstocks?pin_cmp=20&pin_kp=A&pin_keyword1=6731&pin_keyword2=U09Z&pin_userid=+923163301494&pin_password=555&pin_datatype=$ledgerType&pin_fromdate=$fromDate&pin_todate=$toDate');
  ...
  static Future<dynamic> getWalletLedger({ String ledgerType,String fromDate,String toDate}){
    var url=Uri.parse(directory+'getwalletstatus?pin_cmp=20&pin_kp=A&pin_keyword1=6731&pin_keyword2=U09Z&pin_userid=$phoneNumber&pin_password=$password&pin_datatype=$ledgerType&pin_fromdate=$fromDate&pin_todate=$toDate');
    // var url=Uri.parse(directory+'getwalletstatus?pin_cmp=20&pin_kp=A&pin_keyword1=6731&pin_keyword2=U09Z&pin_userid=+923119806626&pin_password=555&pin_datatype=$ledgerType&pin_fromdate=$fromDate&pin_todate=$toDate');
  ...
  static Future<List<City>> getAllCities({Function task}) async{
    List<City> cities;
    var url = Uri.parse(directory+'getcities?pin_cmp=20&pin_kp=A&pin_keyword1=6731&pin_keyword2=U09Z&pin_userid=$phoneNumber&pin_password=$password&pin_city_code=');
  ...
  static Future<List<Area>> getAreaByCity(cityID) async{
    List<Area> areas;
    var url =Uri.parse(directory+'getcityareas?pin_cmp=20&pin_kp=A&pin_keyword1=6731&pin_keyword2=U09Z&pin_userid=$phoneNumber&pin_password=$password&pin_city_code=$cityID');
    print("get city url: "+url.toString());
  ...
  static Future<List<PartyCategories>> getPartyCategories() async{
    ...
    var url =Uri.parse(directory+'getpartycategories?pin_cmp=20&pin_kp=A&pin_keyword1=6731&pin_keyword2=U09Z&pin_userid=$phoneNumber&pin_password=$password&pin_cat_code=');
  ...
  static Future<dynamic> getPartyTrialLedger({ String ledgerType,String fromDate,String toDate}){
    // var url=Uri.parse(directory+ 'gettransactions?pin_cmp=20&pin_kp=A&pin_keyword1=6731&pin_keyword2=U09Z&pin_userid=+923163301494&pin_password=555&pin_cust_code=&pin_datatype=$ledgerType&pin_fromdate=$fromDate&pin_todate=$toDate');
    var url=Uri.parse(directory+ 'gettransactions?pin_cmp=20&pin_kp=A&pin_keyword1=6731&pin_keyword2=U09Z&pin_userid=$phoneNumber&pin_password=$password&pin_cust_code=&pin_datatype=$ledgerType&pin_fromdate=$fromDate&pin_todate=$toDate');
  ...
  static Future<List<MainIssue>> getMainIssue({Function task}) async{
    ...
    var url = Uri.parse(directory+ 'getmainissue?pin_cmp=20&pin_kp=A&pin_keyword1=6731&pin_keyword2=U09Z&pin_userid=$phoneNumber&pin_password=$password&pin_maintype=');
    // print("get city url: "+url.toString());
    await  http.get(url).then((response) {
      var data=jsonDecode(utf8.decode(response.bodyBytes));
      if(response.statusCode==200){
  ...
  static Future<List<SubIssue>> getSubIssueByMainIssue(mainissueId) async{
    ...
    var url =Uri.parse(directory+ 'getsubissue?pin_cmp=20&pin_kp=A&pin_keyword1=6731&pin_keyword2=U09Z&pin_userid=$phoneNumber&pin_password=$password&pin_maintype=$mainissueId');
  ...
  static Future<dynamic> postComplaint({String customercode,String complainDetails,String reasonID,String issueID}){
    var url=Uri.parse(directory+'postcustcomplain?pin_cmp=20&pin_kp=A&pin_keyword1=6731&pin_keyword2=U09Z&pin_userid=$phoneNumber&pin_password=$password&pin_maintype=$reasonID&pin_subtype=$issueID&pin_details=$complainDetails&pin_cust_code=$customercode');
  ...
  static Future<dynamic> getTranactionDetails({String customerCode}) async {
    var url =Uri.parse(directory+ 'getcustomers?pin_cmp=20&pin_kp=A&pin_keyword1=6731&pin_keyword2=U09Z&pin_userid=$phoneNumber&pin_password=$password&pin_cust_code=$customerCode&pin_datatype=CRLB');
  ...
  static Future<dynamic> getDeliveryDetails({String customercode,String dataType,String orderId,bool showFullDetails}) async{
    var url=Uri.parse(
        showFullDetails? directory+ 'gettransactions?pin_cmp=20&pin_kp=A&pin_keyword1=6731&pin_keyword2=U09Z&pin_userid=$phoneNumber&pin_password=$password&pin_cust_code=$customercode&pin_datatype=$dataType&pin_order_no=$orderId'
            : directory+ 'gettransactions?pin_cmp=20&pin_kp=A&pin_keyword1=6731&pin_keyword2=U09Z&pin_userid=$phoneNumber&pin_password=$password&pin_cust_code=$customercode&pin_datatype=$dataType');
  ...
  static Future<dynamic> getBoxDeliveries({String customercode,String dataType}) async{
    var url=Uri.parse(directory+ 'getorders?pin_cmp=20&pin_kp=A&pin_keyword1=6731&pin_keyword2=U09Z&pin_userid=$phoneNumber&pin_password=$password&pin_cust_code=$customercode&pin_datatype=$dataType');
  ...
  static Future<dynamic> postBoxDeliverDetails({BoxModel boxDetails, String customerCode, String lat, String long}) async {
    var url =Uri.parse(directory+ 'postboxdelivery?pin_cmp=20&pin_kp=A&pin_keyword1=6731&pin_keyword2=U09Z&pin_userid=$phoneNumber&pin_password=$password&pin_cust_code=$customerCode&pin_longitude=$long&pin_latitude=$lat&pin_box_tr=${boxDetails.trNumber}');
  ...
  static Future<dynamic> getWalletStatus() async {
    var url=Uri.parse(directory+'getwalletstatus?pin_cmp=20&pin_kp=A&pin_keyword1=6731&pin_keyword2=U09Z&pin_userid=$phoneNumber&pin_password=$password');
    print("url is: "+url.toString());
    final response=await http.get(url);
    return response;
  }
  ...
  static Future<dynamic> getSingleCustomer(String custCode) async {
    String url=directory+
        'getcustomers?pin_cmp=20&pin_kp=A&pin_keyword1=6731&pin_keyword2=U09Z&pin_userid=$phoneNumber&pin_password=$password&pin_datatype=INFO&pin_cust_code=$custCode';
    print("url is: "+url);
  ...
  static Future<List<BankAccountModel>> getbankAccount() async{
    ...
    var url=Uri.parse(directory+'getbankaccounts?pin_cmp=20&pin_kp=A&pin_keyword1=6731&pin_keyword2=U09Z&pin_userid=$phoneNumber&pin_password=$password&pin_bacc_no=');
    print(url.toString());
    await http.get(url).then((response){
      print(response.statusCode.toString());
      var data=jsonDecode(utf8.decode(response.bodyBytes));
  ...
  static Future<dynamic> postCashDeposite({String lat,String long,String accountNumber,String amount, String imageUrl}){
    var url=Uri.parse(directory+'postcashdeposit?pin_cmp=20&pin_kp=A&pin_keyword1=6731&pin_keyword2=U09Z&pin_userid=$phoneNumber&pin_password=$password&pin_longitud=$long&pin_latitude=$long&pin_acc_no=$accountNumber&pin_amount=$amount&pin_image_url=$imageUrl');
    var response=http.post(url,body: null);
    return response;
  }
  static Future<dynamic> getHistory(){
    var url=Uri.parse(directory+'getempvisitlog?pin_cmp=20&pin_kp=A&pin_keyword1=6731&pin_keyword2=U09Z&pin_userid=$phoneNumber&pin_password=$password&pin_cust_code=&pin_loguserid=$phoneNumber&pin_longitude=&pin_latitude=&pin_from_date=&pin_to_date=');
    print('history url is'+url.toString());
    var response=http.get(url);
    return response;
  }
  static Future<dynamic> signIn2(String phoneno,String password) async {
    var url=Uri.parse(directory+'getlogin?pin_cmp=20&pin_kp=A&pin_keyword1=6731&pin_keyword2=U09Z&pin_userid=$phoneno&pin_password=$password&pin_version=230622');
