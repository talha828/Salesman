...
import 'package:salesmen_app_new/screen/search_screen/search_screen.dart';
...
class OfferCategoryScreen extends StatefulWidget {
  ...
  @override
  _OfferCategoryScreenState createState() => _OfferCategoryScreenState();
}

class _OfferCategoryScreenState extends State<OfferCategoryScreen> {
                                          ...
                                          return Row(
                                            children: [
                                              ...
                                              customMenuContainer(
                                                  ...
                                                  width: width,
                                                  ontap: () {
                                                    Get.to(TradingProductScreen(subId: product[index]
                                                        .productsubtypeList[i].productsubtypeId,));
