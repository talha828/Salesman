...
class _AddCustomerScreenState extends State<AddCustomerScreen> {
    ...
    return Stack(
      children: [
        Scaffold(
          ...
          appBar: AppBar(title: Text("Add Customer",style: TextStyle(color: Colors.white),),),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Stack(
                        children: [
                          RectangluartextFeild(
                            onChanged: (String){},
                            onSubmit: (String){},
                            hinttext: actualaddress==null?"Searching":actualaddress.toString(),
                            //cont: currentlocation,
                            enable: false,
                            //onChanged: enableBtn(email.text),
                            keytype: TextInputType.text,
                            textlength: 25, cont: name,
                      ...
                      RectangluartextFeild(
                        ...
                        //onChanged: enableBtn(email.text),
                        keytype: TextInputType.text,
                        textlength: 25, onChanged: (String ) {  }, onSubmit: (String ) {  },
                      ),
                      SizedBox(
                        height: height * 0.03,
                      ),
  ...
  //                     msg: "Please Enter Shop Name", toastLength: Toast.LENGTH_SHORT);
  //               }}
  //             else {
  //               Fluttertoast.showToast(
  //                   msg: "Please Enable Location", toastLength: Toast.LENGTH_SHORT);
  //             }
  //           }
  //
  //           else {
  //             Fluttertoast.showToast(
  //                 msg: "Please Select Party Categories", toastLength: Toast.LENGTH_SHORT);
  //           }}
  //         else {
  //           Fluttertoast.showToast(
  ...
  //   String URL = directory+'postcreateshop?pin_cmp=20&pin_kp=A&pin_keyword1=X09&pin_keyword2=912&'
  ...
  //       fontSize: 16.0
  //   );
  //   Navigator.push(context, SwipeLeftAnimationRoute(widget: SucessFullyAddCustomerScreen()));
  //
  // }
