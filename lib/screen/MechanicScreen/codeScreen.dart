...
class CodeScreen extends StatefulWidget {
  ...
  CodeScreen({Key key, this.pin, this.contactNumbers, this.onSuccess, this.onFailed,this.mechanicName}) : super(key: key);
                    ...
                    Row(
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            VariableText(text: widget.mechanicName,
                        ...
                        Container(child: VariableText(text: widget.contactNumbers,
                          fontsize: height * 0.020,
                          textAlign: TextAlign.start,
                          line_spacing: 1,
                          fontcolor: textcolorblack,
