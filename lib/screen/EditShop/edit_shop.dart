...
class _EditShopScreenState extends State<EditShopScreen> {
  ...
  initState() {
    ...
    print("num 2: ${widget.shopData.customerContactNumber}");
    print(widget.shopData.customerContactNumber2);
  ...
  getUser() async {
    ...
    if (response.statusCode == 200) {
      ...
      secondname =
          TextEditingController(text: userDetails.customerContactPersonName2.toString());
      print(secondname);
      secondphoneno =
          TextEditingController(text: userDetails.customerContactNumber2);
      print(secondphoneno.text);
  ...
  Future<void> editShop(String imageUrl) async {
    try {
      ...
      var response = await OnlineDatabase.editShop(
          ...
          CustomerPhoneNo2:
              secondphoneno.text.toString() == "NULL" ? '' : secondphoneno.text,
  ...
  Future<Response> neweditShop({String emp_id, String customerCode, String lat,String long,String address,})async{
    setLoading(true);
    try{
      ...
      var dio = Dio();
      print(data);
      String url="http://erp.suqexpress.com/api/customer/edit/"+customerCode;
